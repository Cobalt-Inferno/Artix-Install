...
useradd -m cobalt
echo -e "test\ntest" | passwd cobalt
yes | pacman -S doas nano
echo "permit persist cobalt as root" > /etc/doas.conf
pacman -S --noconfirm xorg-xinit xorg git  nvidia
pacman -Syy
EOF
